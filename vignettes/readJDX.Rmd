...
* Variable lists can be presented in several different formats.  The supported formats are:
    ...
    * PEAK TABLE=(XY..XY) Entries are $x$,$y$ pairs separated by spaces or semicolons.  No compression is used.  Used for single MS spectra.
    * DATA TABLE=(XI..XI) Entries are $x$,$y$ pairs separated by spaces.  No compression is used.  Used for instance in LC_MS data sets.
